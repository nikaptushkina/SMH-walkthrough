              ...
              >
                ...
                {isFullscreenBrowse && (
                  <>
                    ...
                    <div
                      className={cn(
                        'fixed bottom-4 left-1/2 z-30 -translate-x-1/2 rounded-2xl border border-white/60 bg-white/45 px-4 py-3 shadow-lg backdrop-blur-md transition-all duration-200',
                        isFullscreenNotesHidden
